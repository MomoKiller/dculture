        ...
        <div class="content-wrap">
            ...
            <div class="welcome">
                <div class="wrap">
                    ...
                    <a class="btn-cancle" @click="lickCount('cut')" v-if="isLikeClick">取消点赞</a>
                </div>
            </div>
        </div>
        <footer>
            <ul>
                ...
                <li>
                    <a class="btn-share" @click="toShare()"></a>
                </li>
                <li>
                    <a class="btn-back" @click="toHomePage()"></a>
                </li>
                <li>
                    <a class="btn-continue" @click="toList()"></a>
                </li>
            </ul>
        </footer>
        <!-- 分享海报 -->
